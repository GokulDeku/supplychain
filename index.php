...
<html lang="en">
  ...
  <?php
    ...
    <div style="width: 100%">
      <center>
        <div class="main-content" id="card1">
            <h1>Welcome to Supplychain DAPP</h1><br>
            <div class="bt-sec">
                <button class="bt" id="login">Login</button>&emsp;&emsp;&emsp;
                <button class="bt" id="signup">Signup</button>
            </div>
        </div>

      <div class="loginformcard reg" id="maincard3">
            ...
            <br>
            <a href="#" class="hl" id="gotologin"> Already have an account? Login to your existing account </a>
            </form>
      </div>


      <div class="loginformcard log" id="maincard2">
      <h4> Login to your existing account</h4>
            ...
            <br>
            <a href="#" class="hl" id="gotosignup"> Don't have an account? Create a new account now</a>
            </form>
